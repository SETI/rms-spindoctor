...
The list is written out rather than taken from the label so that a label carrying a
keyword the list omits is a difference a reader can see, rather than one that drops a
keyword in silence.
"""
