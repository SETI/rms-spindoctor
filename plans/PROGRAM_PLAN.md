...
dev-guide output-layout mismatch tracked by #265; the data label's
`cassini:*` attributes, which are to take the image label's facts from
the navigation document's `observation` block rather than from the index
row, #684), then generalize —
...
Every open issue, listed exactly once by the track that owns it. 242 issues
...
| D — capability completion | 74 | #28, #30, #47, #53, #54, #55, #57, #63, #66, #67, #69, #71, #72, #73, #74, #75, #76, #77, #79, #108, #118, #126, #141, #142, #231, #236, #251, #252, #253, #265, #397, #398, #411, #418, #424, #427, #433, #434, #435, #436, #437, #440, #444, #448, #455, #459, #462, #464, #465, #466, #467, #468, #472, #486, #493, #495, #496, #497, #501, #512, #513, #514, #515, #519, #520, #528, #531, #534, #536, #538, #540, #541, #542, #684 |
