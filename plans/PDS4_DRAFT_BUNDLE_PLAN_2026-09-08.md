...
by no phase, and was tracked as #619, which #624 closed by recording the host's exposure times in the `observation` block. The rows that *would* have
...
times regardless, which this pass does not read; section 2.2 row 18). That is a
