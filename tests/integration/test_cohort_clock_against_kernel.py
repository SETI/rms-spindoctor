...
_SKIPPED = 'the cohort clock kernel tests'
"""What goes unrun when a kernel cannot be retrieved."""

_LSK = retrieved_kernel(
    'SPICE/General/LSK/naif0012.tls', what='the leapseconds kernel', tests=_SKIPPED
)
_SCLK = retrieved_kernel(
    'SPICE/Cassini/SCLK/cas00172.tsc', what='the Cassini clock kernel', tests=_SKIPPED
)
